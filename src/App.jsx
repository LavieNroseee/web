          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <button onClick={() => navigateTo('contacto')} className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-white bg-slate-900 rounded-lg hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl group">
                  Cuéntanos tu proyecto
                  <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </button>
                <button onClick={() => navigateTo('proyectos')} className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-slate-700 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition-all">
                  Ver Proyectos
                </button>
              </div>
            </div>
    ...
    <section className="py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { icon: <Target className="h-10 w-10 text-blue-600" />, title: "Enfoque en Resultados", desc: "No vendemos código, vendemos soluciones a problemas reales." },
            { icon: <Users className="h-10 w-10 text-teal-600" />, title: "Diseño Centrado en Usuario", desc: "Interfaces que tu equipo realmente sabrá y querrá usar." },
            { icon: <Activity className="h-10 w-10 text-indigo-600" />, title: "Escalabilidad", desc: "Sistemas preparados para crecer junto con tu organización." }
          ].map((item, i) => (
...
const AboutPage = () => (
  <div className="pt-24 pb-20">
    <div className="bg-slate-900 text-white py-20 px-4 mb-20">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">Más que consultores, somos aliados estratégicos</h1>
        <p className="text-xl text-slate-300">Nuestra misión es democratizar el acceso a la inteligencia de negocios mediante herramientas digitales accesibles y potentes.</p>
      </div>
    </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
           {[
             { title: "Transparencia", desc: "Código limpio, procesos claros y comunicación honesta en cada etapa." },
             { title: "Innovación Práctica", desc: "No usamos tecnología por moda, sino para resolver problemas reales de forma eficiente." },
             { title: "Compromiso", desc: "Acompañamos a nuestros clientes desde la idea inicial hasta la evolución del producto." }
           ].map((val, i) => (
  ...
  <div className="pt-24 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="text-center mb-16">
      ...
      <p className="text-xl text-slate-600 max-w-3xl mx-auto">
        Ofrecemos un abanico completo de soluciones digitales diseñadas para optimizar la gestión y visualización de información.
      </p>
    </div>
    ...
    <div className="mt-20 bg-blue-600 rounded-3xl p-10 text-center text-white relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="mb-8 opacity-90">Cada organización es única. Conversemos para diseñar una solución específica para usted.</p>
          <a href="#contacto" className="bg-white text-blue-700 font-bold py-3 px-8 rounded-lg hover:bg-blue-50 transition-colors inline-block">Consultar Personalización</a>
        </div>
...
const ProjectsPage = () => {
  ...
  // Novedad: Arreglo de proyectos estilo Galería con tus imágenes
  const staticProjects = [
    {
      title: "Panel de Gestión Corporativa",
      client: "TransNacional Logistics",
      likes: "459",
      views: "3.6k",
      image: "/img/panel-gestion-corporativa.png" // Usa la imagen original que enviaste primero
    },
    {
      title: "Panel Educativo - CampusVivo",
      client: "Universidad Politécnica",
      likes: "1.2k",
      views: "13.8k",
      image: "/img/panel-educativo-campusvivo.png" // Tu imagen de CampusVivo
    },
    {
      title: "Panel de Salud - SaludTotal",
      client: "Red San Marcos",
      likes: "886",
      views: "13.6k",
      image: "/img/panel-salud-total.png" // Tu imagen de SaludTotal
    },
    {
      title: "Panel de Monitoreo - HealthCare+",
      client: "Clínica Internacional",
      likes: "244",
      views: "2.1k",
      image: "/img/panel-monitoreo-healthcare.png" // Tu imagen de HealthCare+
    },
    {
      title: "Panel Corporativo - HealthGuard",
      client: "Aseguradora Andina",
      likes: "140",
      views: "1.2k",
      image: "/img/panel-corporativo-healthguard.png" // Tu imagen del panel corporativo HealthGuard
    },
    {
      title: "Panel de Salud - HealthGuard",
      client: "Ministerio de Salud Pública",
      likes: "256",
      views: "1.9k",
      image: "/img/panel-salud-healthguard.png" // Tu imagen del panel de salud HealthGuard
    }
  ];
    ...
    <div className="pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Explore cómo nuestras soluciones se adaptan a diferentes industrias. Esta demostración interactiva refleja la calidad de nuestros entregables.
          </p>
        </div>
        ...
        <div className="mb-24">
          <div className="flex justify-between items-end mb-8">
            <div>
              <h2 className="text-3xl font-bold text-slate-900 mb-2">Galería de Casos</h2>
              <p className="text-slate-600">Inspiración y resultados visuales de nuestras implementaciones.</p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-10">
            {staticProjects.map((project, idx) => (
              <div key={idx} className="group cursor-pointer flex flex-col">
                {/* Visual Cover (Image) - Ajustado para parecer ventana de software */}
                <div className="relative overflow-hidden rounded-lg aspect-[4/3] mb-3 bg-slate-50 border border-slate-200 shadow-sm flex items-center justify-center">
                  {/* Etiqueta de respaldo si la imagen aún no se carga localmente */}
                  <span className="absolute text-slate-400 text-xs font-medium z-0">Imagen: {project.image}</span>
                  <img 
                    src={project.image} 
                    alt={project.title} 
                  ...
                  <div className="absolute inset-0 bg-slate-900 opacity-0 group-hover:opacity-5 transition-opacity duration-300 z-20"></div>
                </div>
                
                {/* Content - Behance Style Minimalist Footer */}
                <div className="flex justify-between items-start px-1">
                  <div className="pr-4">
                    <h3 className="font-bold text-slate-900 text-sm leading-tight hover:underline">
                      {project.title}
                    </h3>
                    <p className="text-slate-500 text-xs mt-1 hover:text-slate-900 transition-colors">
                      {project.client}
                    </p>
                  </div>
                  
                  {/* Stats (Likes & Views) */}
                  <div className="flex items-center gap-3 text-slate-500 text-xs font-medium shrink-0 pt-0.5">
                    <span className="flex items-center gap-1 hover:text-slate-900 transition-colors">
                      <ThumbsUp size={12} className="fill-current" /> {project.likes}
                    </span>
                    <span className="flex items-center gap-1 hover:text-slate-900 transition-colors">
                      <Eye size={12} className="fill-current" /> {project.views}
                    </span>
                  </div>
                </div>
              </div>
    ...
    <div className="grid lg:grid-cols-2 gap-16">
      <div>
        ...
        <p className="text-lg text-slate-600 mb-8">
          Estamos listos para escuchar sus necesidades y proponer una solución a medida. Complete el formulario y nos pondremos en contacto a la brevedad.
        </p>
        ...
        <form className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none bg-slate-50" placeholder="Ej. Juan Pérez" />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">Empresa</label>
              <input type="text" className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none bg-slate-50" placeholder="Ej. Empresa SAC" />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea rows="4" className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none bg-slate-50 resize-none" placeholder="Cuéntenos sobre su desafío..."></textarea>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            ...
            <div className="hidden md:flex space-x-8 items-center">
              ...
              <button onClick={() => navigateTo('contacto')} className="bg-slate-900 text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-blue-700 transition-colors shadow-lg shadow-blue-900/20">
                Iniciar Proyecto
              </button>
            </div>
            ...
            <div className="px-4 pt-8 pb-3 space-y-4">
              {navLinks.map((link) => (
                <button 
                  key={link.id} 
                  onClick={() => navigateTo(link.id)} 
                  className={`block w-full text-left px-3 py-3 rounded-lg text-lg font-medium ${currentPage === link.id ? 'bg-blue-50 text-blue-600' : 'text-slate-700 hover:bg-slate-50'}`}
                >
                  {link.label}
                </button>
              ))}
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center mb-4">
                <img 
                  src="/img/logo.png" 
                  alt="ADN Analytics" 
                  className="h-13 w-auto grayscale opacity-80 hover:grayscale-0 transition-all" 
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-600">
                <li><button onClick={() => navigateTo('nosotros')} className="hover:text-blue-600">Quiénes Somos</button></li>
                <li><button onClick={() => navigateTo('servicios')} className="hover:text-blue-600">Servicios</button></li>
                <li><button onClick={() => navigateTo('proyectos')} className="hover:text-blue-600">Proyectos</button></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold text-slate-900 mb-4">Legal</h4>
              <ul className="space-y-2 text-sm text-slate-600">
                <li><span className="cursor-pointer hover:text-blue-600">Privacidad</span></li>
                <li><span className="cursor-pointer hover:text-blue-600">Términos</span></li>
              </ul>
            </div>
          </div>
